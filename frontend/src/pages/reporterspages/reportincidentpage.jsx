...
function ReportIncidentPage() {
    ...
    return (
        <div className="report-container">
            ...
            <h2 className="title">Need an Emergency <br/> Service?</h2>

            <Link to="/incident-categories" className="report-circle" >
            ...
            <p className="emergency-call">
                <Link to="/emergency-numbers">EMERGENCY CALL</Link>
            </p>
        </div>
    );
}   
